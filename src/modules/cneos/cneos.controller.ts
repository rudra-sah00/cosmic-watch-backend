...
export const CneosController = {
  /**
   * GET /api/v1/cneos/close-approaches
   * Query: date_min, date_max, dist_max, sort, limit, pha
   */
  ...
  /**
   * GET /api/v1/cneos/sentry
   * Query: ps_min, ip_min, h_max
   */
  ...
  /**
   * GET /api/v1/cneos/sentry/:designation
   */
  ...
  /**
   * GET /api/v1/cneos/fireballs
   * Query: date_min, date_max, limit, sort, energy_min, req_loc
   */
